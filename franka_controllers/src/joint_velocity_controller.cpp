...
#include <franka_controllers/joint_velocity_controller.hpp>
...
CallbackReturn JointVelocityController::on_configure(
  ...
  joint_command_subscriber_ = get_node()->create_subscription<sensor_msgs::msg::JointState>(
      "/hday/rt_franka/joint_velocity_command", rclcpp::SystemDefaultsQoS(),
...
void JointVelocityController::publish_joint_state(const sensor_msgs::msg::JointState& joint_state) {
...
void JointVelocityController::publish_ef_pose(const Eigen::Vector3d ef_position,
